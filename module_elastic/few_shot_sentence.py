...
def classify_intent(question: str) -> Dict:
    ...
    if "giá" in query_classified.lower():
        examples = ELASTIC_SEARCH_CONFIG.example_price
        json_fewshoted =  extract_info(question, examples)
    elif "công suất" in query_classified.lower():
        examples = ELASTIC_SEARCH_CONFIG.example_power
        json_fewshoted =  extract_info(question, examples)
    elif "khối lượng" in query_classified.lower():
        examples = ELASTIC_SEARCH_CONFIG.example_weight
        json_fewshoted =  extract_info(question, examples)
    elif "dung tích" in query_classified.lower():
        examples = ELASTIC_SEARCH_CONFIG.example_volume
        json_fewshoted =  extract_info(question, examples)
    else:
        examples = ELASTIC_SEARCH_CONFIG.example_quantity
        json_fewshoted =  extract_info(question, examples)
